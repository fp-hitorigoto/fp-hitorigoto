...
- 「私自身、〇〇の現場では」「〇〇（具体的な金融機関名）での経験から」など、勤務先や所属組織が特定できる表現は使わないこと。実感や経験を書く場合は「金融機関の現場では」「実際の相談現場では」のように一般的な表現にすること。
...
- 「FP試験のポイント」セクションについて（厳格な基準で判断すること）：
  - 「不動産に関する話題だから不動産分野」のような大分類レベルの連想だけで書いてはいけない。実際にFP技能検定（日本FP協会・きんざい）の教科書・出題範囲表に載っている具体的な項目と一致する場合にのみ書くこと
  - 書いてよい具体例：公的年金（老齢・障害・遺族年金の仕組み）、健康保険・介護保険・雇用保険の基本、高額療養費制度、NISA・iDeCoの制度概要、所得税・相続税・贈与税の基本的な仕組みと控除、借地借家法・区分所有法・建築基準法、不動産の取得・保有・譲渡に関する税金、生命保険・損害保険の基本、相続の基本（法定相続分・遺言・遺留分等）
  - 書いてはいけない例：公営住宅法のような個別の行政法・地方自治体の制度、労働基準法の細かい実務（賃金控除の手続きなど）、生活保護の実務手続き、行動経済学などの学術理論、その他FPの一般的な教科書に載っていないニッチな法律・制度。これらは「不動産」「社会保険」等の大分類に属していても、FP試験の標準的な出題範囲には含まれないことが多いため、確信が持てない限り書かない
  - 少しでも「本当にFP試験の教科書に載っているか自信がない」と感じたら、このセクションは書かず「実生活への影響・活用法」のみにすること。書かないことによる減点はない
  - このセクションを書く場合でも、「FP試験に出題される」「頻出テーマ」のように出題実績を断定してはいけない（制度の解説に留め、出題の有無には触れない）"""
